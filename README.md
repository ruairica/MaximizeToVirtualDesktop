...
### DeskSwitch
`Ctrl+Alt+Space` overlay to fuzzy-search, switch, create, and remove virtual desktops. This may be useful to anyone looking for a lightweight virtual desktop manager on Windows 11.
...
### DevDesk
Creates a new virtual desktop with Terminal + VS Code + Chrome pre-arranged. This is highly personalised to my workflow and probably isn't useful to you.
